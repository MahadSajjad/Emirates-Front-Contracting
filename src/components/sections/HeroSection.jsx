...
import ConstructionInfinityLoop from "../animations/ConstructionInfinityLoop.jsx";

export const HeroSection = () => {
  const heroWhatsAppUrl = buildWhatsAppLink();

  return (
    <section className="relative min-h-[94vh] flex items-center bg-slate-950 text-white overflow-hidden">
      ...
      {/* Infinity Construction Flow Loop Background Animation Layer */}
      <div className="absolute inset-0 flex items-center justify-center opacity-35 sm:opacity-45 pointer-events-none z-[2]">
        <ConstructionInfinityLoop width={720} height={360} speed={0.0025} />
      </div>
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-5 relative hidden sm:block">
            ...
            <div className="relative rounded-2xl overflow-hidden glass-card-dark p-6 shadow-2xl border border-primary-500/30 hover-lift bg-slate-900/80">
              <div className="relative h-64 rounded-xl overflow-hidden mb-5">
                <img
                  ...
                  alt="Construction Engineering Site in Riyadh"
            ...
            <div className="absolute -bottom-6 -left-6 z-20 glass-card-dark px-4 py-3 rounded-xl shadow-xl border border-primary-400/30 flex items-center gap-3 animate-float-slow hover:border-cta transition-colors bg-slate-900/90">
              ...
              <div>
                ...
                <span className="block font-mono text-[11px] text-slate-400">
                  Excavation & Site Compaction
                </span>
              </div>
            </div>

            {/* Floating Metric 2: Envelope Engineering */}
            <div className="absolute -top-6 -right-4 z-20 glass-card-dark px-4 py-3 rounded-xl shadow-xl border border-primary-400/30 flex items-center gap-3 animate-float-reverse hover:border-cta transition-colors bg-slate-900/90">
